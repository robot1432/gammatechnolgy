...
//Any actions desired at this point should be coded in this file
                        ...
                        else
                        {
                            ...
                            $sql = "$sql $where AND " . suJsonExtract('data', 'working_status', FALSE) . " = 'Incomplete' $sort LIMIT " . $_GET['start'] . "," . $getSettings['page_size']; //This page
                            $sqlDl = "$sqlDl $where AND " . suJsonExtract('data', 'working_status', FALSE) . " = 'Incomplete' $sort LIMIT " . $_GET['start'] . "," . $getSettings['page_size']; //Download page
                            $result = suQuery($sql);
                            $numRows = $result['num_rows'];
                        }
