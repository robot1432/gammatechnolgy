...
<!-- This Site -->
<?php 
if ($_SESSION[SESSION_PREFIX . 'admin_login'] == 1 && $_SESSION[SESSION_PREFIX . 'user_group'][0] == 'Admin') { ?>
<script>
    $("#data_div_photo").hide();
    $("#data_div_signature").hide();
    $("#data_div_id_card").hide();
    $("#data_div_joining_date").hide();
</script>
<?php } ?>
